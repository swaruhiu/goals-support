...
function App() {
  return (
    <div className="App">
      ...
      <p>
        Waruhiu built the Goals app as a Free app. This SERVICE is provided by
        Waruhiu at no cost and is intended for use as is. This page is used to
        ...
        Terms and Conditions, which are accessible at Goals unless otherwise
        defined in this Privacy Policy.
      </p>
      <h2>Information Collection and Use</h2>
      <p>
        The Goals application does not collect any Personal Information with any
        intention or for any purpose. Nonetheless, the following services may
        collect information as mentioned below.
      </p>
      <p>
